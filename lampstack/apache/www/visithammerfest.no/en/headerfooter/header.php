...
?>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                    ...
                    <li class="nav-item"><a class="nav-link link text-black display-4" href="index.php?page=booking&lang=no">Bestilling</a></li>
                ...
                <div class="icons-menu">
                    <a href="index.php?page=<?php if (isset($_GET['page'])) {echo $_GET['page'];}else{}?>&lang=en<?php if (isset($_GET['id'])) {echo "&id=" . $_GET['id'];}else{}?>" aria-expanded="false">
...
?>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                    ...
                    <li class="nav-item"><a class="nav-link link text-black display-4" href="index.php?page=booking&lang=en">Booking</a></li>
                    

                </ul>

                <div class="icons-menu">
                    <a href="index.php?<?php if (isset($_GET['page'])) {echo 'page=' . $_GET['page'];}else{}?>&lang=no<?php if (isset($_GET['id'])) {echo "&id=".$_GET['id'];}else{}?>" aria-expanded="false"><img class="flag-img" style="width: auto !important" width="30" height="20" src="assets/images/flags/no.svg" alt="Flag of Norway"></a>
                    <a class="iconfont-wrapper" href="https://www.facebook.com/visithammerfest/" target="_blank">
                        <span class="p-2 mbr-iconfont socicon-facebook socicon"></span>
                    </a>
                    <a class="iconfont-wrapper" href="https://www.instagram.com/visithammerfest/" target="_blank">
