            ...
            <div class="row row-links">
                <ul class="foot-menu">                   
                    <li class="foot-menu-item mbr-fonts-style display-7">
                        <a class="text-primary" href="https://visit-hammefest-media.flywheelsites.com/wp-login.php?redirect_to=https%3A%2F%2Fvisit-hammefest-media.flywheelsites.com%2F&reauth=1" target="_blank"><?php echo $lang === 'no' ? 'Mediabank' : 'Media bank'; ?></a>
                    </li>
                    <li class="foot-menu-item mbr-fonts-style display-7">
                    ...
                    <li class="foot-menu-item mbr-fonts-style display-7">
                        <a class="text-primary" href="index.php?page=legal&lang=<?php echo $lang === 'no' ? 'no' : 'en'; ?>" target="_blank"><?php echo $lang === 'no' ? 'Personvern' : 'Pricvacy'; ?></a>
                    </li>
                    <li class="foot-menu-item mbr-fonts-style display-7">
