export const sampleCalendarEvents = [
    {
        ...
        summary: 'Prøv VR-utstyr, bygg din egen rakett og lær hvordan vi planlegger fremtidens ferder til månen.',
    ...
    },
    {
        ...
        summary: 'Ta med deg et prosjekt eller få hjelp av våre mentorer til å bli kjent med 3D-printere, laserskjærere og loddebolter.',
        hosts: ['Olav', 'Emily'],
    ...
    },
    {
        ...
        summary: 'Videregående skoleklasser testes i fornybar energi, turbiner og ekte data fra industrien.',
        hosts: ['Energiteamet'],
    ...
    },
    {
        ...
        endTime: '22:00',
        location: 'Hovedsalen',
        summary: 'Kveld for nysgjerrige voksne med miniforedrag, smarte demoer og taffelmusikk i loungen.',
...
export const sampleAboutProfiles = [
    {
        id: 'about-lise',
